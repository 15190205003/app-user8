...
//	}
	...
	public static float transFloat(float num){
		...
		float   resf   =  b.setScale(2,  BigDecimal.ROUND_HALF_UP).floatValue();
		return  resf;
	}
	public static double transFloatToDouble(float num){
		BigDecimal   b  =   new BigDecimal(num);
		double   resf   =  b.setScale(2,  BigDecimal.ROUND_HALF_UP).doubleValue();
		return  resf;
	}
	public static double transDoubleFixed2(double num){
	...
	public static double transDoubleFixed2(double num, int digit){
		/*if(StringUtils.isDouble(num + "")){*/
			BigDecimal   b  =   new BigDecimal(num);
			double   resf   =  b.setScale(digit,  BigDecimal.ROUND_HALF_UP).doubleValue();
			return  resf;
		/*}
		return num;*/
	}
